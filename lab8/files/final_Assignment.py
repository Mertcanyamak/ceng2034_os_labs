...
import json
import shutil
with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "mert.json")) as mert_file:
    mert = json.loads(mert_file.read())
{
    "123": {
        "signs": [
            "0,00001A00051004"
...
for file in os.listdir(directoryy):
    getlist = os.system('file ' + file)
    print (getlist)
